...
try:
    ...
    MazeNode.visualize_maze_svg(random_maze, shortest_path, new_shortest_path, start_point, end_point, reward_locations, enemy_positions, file_name='maze_with_paths.svg')

except ValueError as e:
    print(e)
    MazeNode.visualize_maze_svg(random_maze, [], [], start_point, end_point, [], [], file_name='maze_no.svg')

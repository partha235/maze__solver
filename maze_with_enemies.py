...
random_maze = generate_random_maze(rows, cols, num_enemies=random_num_enemies, num_rewards=random_num_rewards)
...
try:
    ...
    visualize_maze_svg(random_maze, shortest_path, new_shortest_path, start_point, end_point, reward_locations, enemy_positions, file_name='maze_with_both_paths.svg')

except ValueError as e:
    print(e)
    visualize_maze_svg(random_maze, [], [], start_point, end_point, [], [], file_name='maze_no_path.svg')
